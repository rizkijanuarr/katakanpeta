...
import { Search, Loader2, MapPin, Star, Phone, Globe, ExternalLink } from 'lucide-react'
      ...
      <Main>
        ...
        <Tabs defaultValue='scrape' className='space-y-6'>
          <TabsList>
            ...
            <TabsTrigger value='logs' onClick={fetchLogs}>Scrape Logs</TabsTrigger>
          </TabsList>
            ...
            <Card>
              ...
              <CardContent>
                {logsLoading ? (
                  ...
                  <div className='py-8 text-center text-muted-foreground'>
                    <Search className='mx-auto h-8 w-8 mb-2 opacity-50' />
                    <p>No scrape logs yet. Start scraping to see your history here!</p>
                  </div>
                )}
              </CardContent>
            </Card>
